;;; two-to-tango-theme.el --- Tango-based custom theme for faces  -*- lexical-binding:t -*-

;;; Commentary:

;; Total rip-off of the built in tango theme to avoid italics in the comments
;; The colors in this theme come from the Tango palette, which is in
;; the public domain: http://tango.freedesktop.org/

;;; Code:

(deftheme two-to-tango
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((,class (:foreground ,alum-5))))
...
(provide-theme 'two-to-tango)

;;; two-to-tango-theme.el ends here
