...
(defun book-center ()
  ...
  (split-window-right)
  (balance-windows)
  (find-file "~/langmartin/mkelixir/Book/code/petite/docs/lang-book-diary.md")
  (other-window 2)
  (find-file "~/langmartin/mkelixir/Book/code/petite/lib/petite/application.ex")
  (other-window 2)
...
;; (add-to-list 'load-path "~/langmartin/dot-file/site-themes/almost-mono-themes")
;; (add-to-list 'custom-theme-load-path "~/langmartin/dot-file/site-themes/almost-mono-themes")
;; (rc-init-emacs)
;; (rc-look-and-feel)
;; (rc-init-site-lisp)
;; (rc-emacs-master)
